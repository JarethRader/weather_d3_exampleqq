...
class LineChart extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    const tempMax = d3.max(data.data, d => d.apparentTemperatureHigh);
    ...
    lineGenerator.y(d => yScale(d.apparentTemperatureLow));
    const lows = lineGenerator(data.data);
    // const lows = lineGenerator(data);
    // and then highs
    lineGenerator.y(d => yScale(d.apparentTemperatureHigh));
    const highs = lineGenerator(data.data);
